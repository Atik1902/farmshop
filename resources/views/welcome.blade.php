...
{{--                    <img class="img-fluid" src="landing/images/categories_img_01.jpg" alt="" />--}}
{{--                    <a class="btn hvr-hover" href="#">Lorem ipsum dolor</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">--}}
{{--                <div class="shop-cat-box">--}}
{{--                    <img class="img-fluid" src="landing/images/categories_img_02.jpg" alt="" />--}}
{{--                    <a class="btn hvr-hover" href="#">Lorem ipsum dolor</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">--}}
{{--                <div class="shop-cat-box">--}}
{{--                    <img class="img-fluid" src="landing/images/categories_img_03.jpg" alt="" />--}}
{{--                    <a class="btn hvr-hover" href="#">Lorem ipsum dolor</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                    <img class="img-fluid" src="landing/images/add-img-01.jpg" alt="" />--}}
{{--                </div>--}}
{{--            </div>--}}
{{--            <div class="col-lg-6 col-md-6 col-sm-12">--}}
{{--                <div class="offer-box-products">--}}
{{--                    <img class="img-fluid" src="landing/images/add-img-02.jpg" alt=""  />--}}
{{--                </div>--}}
{{--            </div>--}}
