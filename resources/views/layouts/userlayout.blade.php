...
<head>
    ...
    <!-- Site Metas -->
    <title>Farmshop - Welcome Dear User</title>
...
{{--                    <li class="nav-item"><a class="nav-link" href="/adminlogin">Admin Panel</a></li>--}}
                    ...
                    <li class="nav-item"><a class="nav-link" href="/userview">My Orders</a></li>
                    <li class="nav-item"><a class="nav-link" href="/searchmenu">Search Products</a></li>

                    <li class="nav-item"><a class="nav-link" href="/customercattle">Buy Cattles</a></li>
                    <li class="nav-item"><a class="nav-link" href="/customerproducts">Products</a></li>
                    <li>
                        <a class="nav-link"
